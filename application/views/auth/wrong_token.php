...
<title>Golden Acorn Casino</title>
...
<head>
    ...
    <style>
        ...
        .display-1 {text-align:center;color: rgba(30, 43, 50, 0.47);}
        .display-3 {text-align:center;color: rgba(30, 43, 50, 0.53);}
    ...
    <div class="container-fluid" id="body-container-fluid">
        <div class="container">
            ...
            <div class="jumbotron">
                ...
                <p class="lower-case">This link isn't valid anymore</p>
